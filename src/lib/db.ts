  ...
  categories: {
    ...
    async create(data: Omit<Category, 'id' | 'createdAt' | 'isActive'> & { isActive?: boolean }): Promise<Category> {
      ...
      try {
        ...
        if (error) console.warn('[Supabase categories.create write failed]', error.message);
      } catch (err) {
    ...
    async update(id: string, updateData: Partial<Category>): Promise<Category | null> {
      ...
      try {
        ...
        if (error) console.warn('[Supabase categories.update write failed]', error.message);
      } catch (err) {
    ...
    async delete(id: string): Promise<boolean> {
      ...
      try {
        ...
        if (error) console.warn('[Supabase categories.delete failed]', error.message);
      } catch (err) {
  ...
  products: {
    ...
    async create(data: Omit<Product, 'id' | 'sku' | 'slug' | 'createdAt' | 'updatedAt' | 'isActive'>): Promise<Product> {
      ...
      try {
        ...
        if (err1) {
          ...
          if (err2) console.warn('[Supabase products.create write failed]', err2.message);
        }
      } catch (err) {
    ...
    async update(id: string, updateData: Partial<Product>): Promise<Product | null> {
      ...
      try {
        ...
        if (err1) {
          const { error: err2 } = await supabase.from('products').upsert(baseRow);
          if (err2) console.warn('[Supabase products.update write failed]', err2.message);
        }
      } catch (err) {
    ...
    async delete(id: string): Promise<boolean> {
      ...
      try {
        ...
        if (error) console.warn('[Supabase products.delete failed]', error.message);
      } catch (err) {
